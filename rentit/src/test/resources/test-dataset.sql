...
insert into plant_inventory_entry (id, name, description, price) values (14, 'D-Truck', '20 Tonne Articulating Dump Truck', 280);
insert into plant_inventory_entry (id, name, description, price) values (15, 'D-Truck', '30 Tonne Articulating Dump Truck', 300);
